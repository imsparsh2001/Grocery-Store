  ...
  <footer>
    <section>
      ...
      <article className="payment-bar">
        <div>
          <p>
            ...
            <img width="200px" src="/Images/payment.png" alt="paymentgateways.png" />
          </p>
        </div>

        <!-- App download Locations  -->
        <div>
          <img width="150px" height="30px" src="/Images/AppStore.png" alt="appstore.png" />
          <img width="150px" height="30px" src="/Images/GooglePlay.png" alt="googleplay.png" />
        </div>
      </article>
      ...
      <article className="social-bar">
        <p>Follow us on</p>
        <img width="100px" height="25px" src="/Images/social.PNG" alt="socialnetworks.png" />
      </article>
    </section>
  </footer>
</template>
...
<style src="../landingPage styles/FooterComp.css" scoped></style>
